...
//  melon
//
//  Created by Arie on 3/1/13.
//  Copyright (c) 2013 mokletdev. All rights reserved.
//

#import "mokletConstant.h"

@implementation mokletConstant
...
NSString* const mokletNavbarImageLogin=@"login";
NSString* const mokletAlreadyRegister=@"already";
@end
